        ...
        {route.elevation && (
          <>
            <div className="border-t pt-3 mt-3">
              <h4 className="font-semibold text-sm mb-2 text-gray-700">Высота</h4>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Сброс высоты:</span>
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Мин. высота:</span>
                  <span className="font-semibold">
        ...
        {route.trailQuality && (
          <div className="border-t pt-3 mt-3">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Гладкость:</span>
                <span className="font-semibold capitalize">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Официальные тропы:</span>
                <span className="font-semibold">
              ...
              {route.trailQuality.avgWidth && (
                <div className="flex justify-between">
                  <span className="text-gray-600">Средняя ширина:</span>
                  <span className="font-semibold">
