    ...
    <div className="fixed inset-0 z-[3000] bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl max-w-2xl w-full max-h-[80vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b dark:border-gray-700">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">История маршрутов</h2>
          <button
            onClick={onClose}
          ...
          {!isLoading && !error && routes.length > 0 && (
            <div className="space-y-3">
              {routes.map((route) => (
                <div
                  key={route.id}
                  className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:border-blue-300 dark:hover:border-blue-500 transition-colors"
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-lg mb-2 truncate text-gray-900 dark:text-white">{route.name}</h3>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm text-gray-600 dark:text-gray-300">
                        <div>
                          <span className="text-gray-500 dark:text-gray-400">Расстояние:</span>{' '}
                        ...
                        <div className="col-span-2 text-xs text-gray-400 dark:text-gray-500 mt-1">
