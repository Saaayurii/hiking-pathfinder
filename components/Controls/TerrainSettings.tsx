    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-800 dark:text-gray-200">Настройки проходимости</span>
        </div>
        <svg
      ...
      {/* Settings panel */}
      {isOpen && (
        <div className="border-t dark:border-gray-700 p-4 max-h-96 overflow-y-auto">
          <div className="space-y-4">
            ...
            {Object.entries(surfaceGroups).map(([groupName, surfaces]) => (
              <div key={groupName} className="space-y-2">
                <h4 className="font-semibold text-sm text-gray-700 dark:text-gray-300">{groupName}</h4>
            ...
            <div className="flex gap-2 pt-4 border-t dark:border-gray-700">
              <button
                onClick={handleReset}
                className="flex-1 px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors font-medium text-sm"
              >
                Сбросить
              </button>
              <button
